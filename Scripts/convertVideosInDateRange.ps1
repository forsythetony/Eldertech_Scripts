...
function updateFilesInRange($range, $pathToFiles)
{
    ...
    Get-ChildItem -Path $pathToFiles -Recurse | Where-Object {$_.Name -like "*.txt" -and !$_.PSIsDirectory -and $_.CreationTime -gt $range.start -and $_.CreationTime -lt $range.end} | Foreach-Object{
